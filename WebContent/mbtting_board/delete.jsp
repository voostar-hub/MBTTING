...
<body>
    ...
    <hr>
    <form action="delete_ok.jsp?b_no=<%= b_no %>&board_type=<%= type %>" method="post" name="delete_frm">
		<div class="deleteForm_div">
			<div class="delete_box">
				...
				<div class="delete_pwd">
					<p>비밀번호</p>
					<input type="password" placeholder="글 비밀번호를 입력해주세요." name="pwd">
				</div>
				<div class="delete_btn">
					<input type="button" value="삭제하기" onclick="delete_check()" class="input1">
