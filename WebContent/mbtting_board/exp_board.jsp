...
%>
    	...
    	<form>
	    	<table class="t">
	    		...
	    		<%
	    			...
	    			ArrayList<BoardBean> list = db.explistBoard(pageNum, col, content);
	    	...
	    	<div class="paging"><%= BoardBean.exp_pageNumber(5, col, content) %></div>
    	</form>
    </div>
    <%
   		ArrayList<BoardBean> list2 = db.explistBoard(pageNum, col, content);
    	int b_no = 0;
	...
	%>
			<div class="board2">
    			<form name="search_frm" action="exp_board.jsp" method="post" onsubmit="return false">
