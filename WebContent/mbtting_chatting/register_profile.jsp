...
%>
	...
	<header class="board-header">
      <h1><a href="#">채팅 프로필 등록</a></h1>
    </header>
	<hr />
	<div class="register_pro_maindiv">
		<form action="register_profile_ok.jsp" name="register_prof_frm" class="register_prof_frm" >
			...
			<div class="register_prof_input">
				...
				<input type="text" name="p_content" placeholder="본인 소개글은 20자 내로 작성해주세요" maxlength="20">		
			</div>
			<!-- <div class="register_prof_input">
				<p><label for="p_content">프로필 사진 등록</label></p>
				<input type="file" name="filename1" size="40" class="upload_input">		
			</div> -->
			<div class="register_prof_input_btn">
				<input type="button" value="등록하기" onclick="profile_register()">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
