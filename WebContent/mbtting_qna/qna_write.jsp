...
%>
	...
	<div class="write_form">
		<form name="qna_write_frm" action="qna_write_ok.jsp" method="post">
			<div class="writeForm_div">
				...
				<div class="write_selectbox">
					<select class="selectbox" name="question_type">
						<option value="fail" selected="selected">질문유형을 선택해주세요</option>
						<option value="board">게시판 관련</option>
						<option value="chatting">채팅 관련</option>
						<option value="etc">기타</option>
					</select>
				</div>
				<div class="title_div">
					<input type="text" name="qna_title" placeholder="제목을 입력해 주세요." class="title" maxlength="60">
				</div>
				<div class="content_div">
					<textarea name="qna_content" class="content" placeholder="내용을 입력해 주세요." maxlength="1000"></textarea>
				</div>
				<div class="input_div">
					<div class="pwd_div">
					...
					<div class="input_btn_div">
						...
						<input type="button" value="작성 완료" onclick="qna_write_check()" class="write_ok_btn">
					</div>
				</div>
			</div>
		</form>
