...
%>
	...
	<header class="board-header">
		<h1>
			<a href="etc_qna.jsp">Q & A - 기타 관련</a>
		</h1>
	</header>
	<hr />
	<%
		...
		<div class="qna_main_div">
			<form>
				<table class="t">
					...
					ArrayList<BoardBean> list = db.etcQnaList(pageNum, col, content);
				...
				<div class="paging"><%=BoardBean.etc_qna_pageNumber(5, col, content)%></div>
			</form>
		</div>
	</div>
	<%
		ArrayList<BoardBean> list2 = db.etcQnaList(pageNum, col, content);
	int qna_no = 0;
