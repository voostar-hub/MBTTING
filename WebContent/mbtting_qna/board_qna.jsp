...
%>
	...
	<header class="board-header">
		<h1>
			<a href="board_qna.jsp">Q & A - 게시판 관련</a>
		</h1>
	</header>
	<hr />
	<%
		...
		<div class="qna_main_div">
			<form>
				<table class="t">
					...
					ArrayList<BoardBean> list = db.boardQnaList(pageNum, col, content);
				...
				<div class="paging"><%=BoardBean.board_qna_pageNumber(5, col, content)%></div>
			</form>
		</div>
	</div>
	<%
		ArrayList<BoardBean> list2 = db.boardQnaList(pageNum, col, content);
	int qna_no = 0;
