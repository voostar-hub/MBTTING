...
%>
	...
	<div class="mypage_body">
		<form class="mypage_wrapper" name="mypage_frm" method="post" action="myPageOk.jsp?user_id=<%= id %>">
			<div class="mypage_content">
				<div>
					<h1>내 정보 관리</h1>
					<p>비밀번호를 입력해주세요</p>
					<span>회원님의 개인정보를 안전하게 보호하기 위해 비밀번호를 다시 한 번 확인합니다.</span>
				</div>
				<div class="mypage_content_input">
					<h3>
						<label for="user_pw">비밀번호</label>
					</h3>
					<input type="password"
						name="user_pw" class="reg user" maxlength="20" placeholder="비밀번호 입력">
				</div>
				<div class="btn_area">
					<input type="button" id="btnJoin" value="확인" onclick="myp_check_ok()">
				</div>
			</div>
		</form>
	</div>
