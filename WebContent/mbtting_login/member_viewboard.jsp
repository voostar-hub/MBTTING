	    	...
	    	<div>
		    	<table class="mb_t">
		    		<tr>
						...
						<td class="mb_board-top" align="center">제목</td>
						<td class="mb_board-top" width="150" align="center">작성자</td>
						<td class="mb_board-top" width="100" align="center">작성일</td>
						<td class="mb_board-top" width="40" align="center">조회</td>
						<td class="mb_board-top" width="40" align="center">추천</td>
		    		</tr>
		    		<%
		    			...
		    			ArrayList<BoardBean> list = db.member_listBoard(pageNum, nick);
					...
					%>
						<tr class="list_on">
							...
							<td align="center"><a href="../mbtting_board/show.jsp?b_no=<%= b_no %>&board_type=<%= board_type %>"><%= title %></a></td>
							...
							<td align="center"><a href="../mbtting_board/show.jsp?b_no=<%= b_no %>&board_type=<%= board_type %>"><%= count %></a></td>
							<td align="center"><a href="../mbtting_board/show.jsp?b_no=<%= b_no %>&board_type=<%= board_type %>"><%= good %></a></td>
						</tr>
		    		<%
						}
		    		%>
		    	</table>
			    <div class="mb_paging"><%= BoardBean.member_pageNumber(4) %></div>
	    	</div>
	    </div>
	</div>
    <hr />
