...
%>
	...
	<div class="delete_body">
		<form class="delete_wrapper" name="delete_user_frm" method="post" action="deleteMemberOk.jsp">
			<div class="delete_content">
				<div>
					<h1>회원 탈퇴</h1>
					<p>비밀번호를 입력해주세요</p>
					<span>정말 탈퇴하시려면 비밀번호를 다시 한 번 입력해주세요.</span>
				</div>
				<div class="delete_content_input">
					<h3>
				...
				<div class="btn_area">
					<input type="button" id="btnJoin" value="탈퇴하기" onclick="dlt_check_ok()">
				</div>
			</div>
		</form>
	</div>
