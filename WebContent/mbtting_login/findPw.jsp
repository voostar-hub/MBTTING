...
%>
	...
	<hr />
	<form name="findpw_frm" method="post" action="findPwOk.jsp">
		<div class="find_frm_div">
			<h1 class="find_header">비밀번호 찾기</h1>
			<p>비밀번호는 가입 시 입력하신 아이디와 이메일을 통해 찾으실 수 있습니다.</p>
		</div>
		<div class="find_inf">
			<div>
				<input type="text" class="find_user" name="user_id"
					placeholder="아이디">
			</div>
			<div>
			...
			<div>
				<input class="find_sub" type="submit" value="찾기" onclick="findpw_check_ok()">
			</div>
		</div>
	</form>
	<hr />
