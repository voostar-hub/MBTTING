				...
				%>
						<div class="dropdown">
							...
							<div class="dropdown-content">
								...
								<a href="../mbtting_notice/login.jsp">공지사항</a>
							</div>
						</div>	
				<%
					} 
...
%>
	...
	<hr />
	<form name="log_frm" method="post" action="loginOk.jsp">
		<div class="log_frm_div">
			<h1 class="log_login">LOGIN</h1>
		</div>
		<div class="log_inf">
			<div>
				<input type="text" class="log_user" name="user_id"
					placeholder="아이디">
			</div>
			<div>
				<input type="password" class="log_user" name="user_pw"
					placeholder="비밀번호">
			</div>
			<div>
				<input class="log_sub" type="submit" value="로그인">
			</div>
		</div>
		<div>
			<div class="log_reg">
				<div>
					<input class="log_reg_btn" type="button" value="회원가입"
						onclick="javascript:window.location='register.jsp'">
				</div>
				<div>
					<input class="log_search_btn" type="button" value="아이디"
						onclick="javascript:window.location='findId.jsp'">·
					<input class="log_search_btn" type="button" value="비밀번호 찾기"
