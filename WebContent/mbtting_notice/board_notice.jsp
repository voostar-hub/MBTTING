...
%>
	...
	<header class="board-header">
		<h1>
			<a href="board_notice.jsp">게시판 공지사항</a>
		</h1>
	</header>
	<hr />
	<%
		...
		<div class="notice_main_div">
			<form>
				<table class="t">
					...
					ArrayList<BoardBean> list = db.boardNoticeList(pageNum, col, content);
				...
				<div class="paging"><%=BoardBean.board_notice_pageNumber(5, col, content)%></div>
			</form>
		</div>
	</div>
	<%
		ArrayList<BoardBean> list2 = db.boardNoticeList(pageNum, col, content);
		int n_no = 0;
	...
	%>
	<div class="board2">
		<form name="notice_search_frm" action="board_notice.jsp" method="post"
	...
	if (id.equals("admin1") || id.equals("admin2") || id.equals("admin3")) {
			...
			<input type="button" value="새글 쓰기"
				onclick="location.href='notice_write.jsp'" class="write_btn">
			<%
		}
	%>
	<hr />
