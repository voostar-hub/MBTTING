...
%>
    ...
    <hr>
    <form action="notice_delete_ok.jsp?n_no=<%= n_no %>&notice_type=<%= n_type %>" method="post" name="notice_delete_frm">
		<div class="deleteForm_div">
			<div class="delete_box">
				...
				<div class="delete_pwd">
					<p>비밀번호</p>
					<input type="password" placeholder="글 비밀번호를 입력해주세요." name="n_pwd">
				</div>
				<div class="delete_btn">
					<input type="button" value="삭제하기" onclick="notice_delete_check()" class="input1">
